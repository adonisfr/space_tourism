	...
	return (
		...
		>
			<div className="flex flex-col lg:flex-row gap-5 px-6 lg:justify-between lg:space-x-48 lg:pt-40 lg:pl-24">
				...
				<div className="flex items-center justify-center w-full  mt-10  md:mt-32 ">
					<Link to="/destinations">
						<div className="flex items-center justify-center bg-white w-[150px] md:w-52 h-[150px] md:h-52 lg:w-[204px] lg:h-[204px] rounded-full">
